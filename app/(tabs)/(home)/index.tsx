...
import { Camera, FlashMode, useCameraPermissions, CameraType, CameraView } from 'expo-camera';
...
export default function PhotoScreen() {
  ...
  if (!permission) return <View style={styles.container}><Text>Requesting permissions…</Text></View>;
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <View style={styles.topRow}>
        <Image source={require('@/assets/logo/MEMO_light.png')} style={{ width: 50, height: 50 }} />
        <View style={styles.cameraControlsContainer}>
          <TouchableOpacity style={[styles.flashButton, { paddingRight: 20 }]} onPress={toggleZoom}>
