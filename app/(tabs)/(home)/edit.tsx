import { StyleSheet, Image, Text, View, Dimensions, Button, TouchableOpacity, TextInput } from "react-native";
...
export default function Edit() {
  ...
  const { capturedImage,selectedStatus, setSelectedStatus, selectedHashtag, setSelectedHashtag } = useImageContext();
  ...
  const [tempStatus, setTempStatus] = useState<Status | null>(() => selectedStatus ?? null);
  const [hashtag, setHashtag] = useState<string| null>(() => selectedHashtag ?? null);
