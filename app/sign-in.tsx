      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.errorContainer}>
          <AuthInput
            ...
            typeUser={typeUser}
            setNext={setNext}
            ref={currentStep === "input" ? inputRef as React.RefObject<TextInput> : passwordRef as React.RefObject<TextInput>}
            nextRef={currentStep === "input" ? passwordRef as React.RefObject<TextInput> : undefined}
          />
