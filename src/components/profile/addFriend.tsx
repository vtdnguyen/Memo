...
import MiniAvatar from "@/src/components/auth/miniAvatar";
...
export default function AddFriend() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Path
          d="M16.5 7.33301C18.0188 7.33301 19.25 6.10179 19.25 4.58301C19.25 3.06422 18.0188 1.83301 16.5 1.83301C14.9812 1.83301 13.75 3.06422 13.75 4.58301C13.75 6.10179 14.9812 7.33301 16.5 7.33301Z"
          stroke="black"
          strokeWidth={2}
          strokeLinecap="round"
        ...
        />
        <Path
          d="M16.5 20.167C18.0188 20.167 19.25 18.9358 19.25 17.417C19.25 15.8982 18.0188 14.667 16.5 14.667C14.9812 14.667 13.75 15.8982 13.75 17.417C13.75 18.9358 14.9812 20.167 16.5 20.167Z"
          stroke="black"
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <Path
          d="M7.87415 12.3838L14.135 16.0321"
          stroke="black"
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <Path
          d="M14.1258 5.96777L7.87415 9.61611"
          stroke="black"
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round"
